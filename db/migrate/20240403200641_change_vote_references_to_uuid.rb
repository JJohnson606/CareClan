class ChangeVoteReferencesToUuid < ActiveRecord::Migration[7.0]
  def change
   ...
   add_index :votes, [:votable_id, :votable_type, :vote_scope], name: 'index_votes_on_votable_and_scope'
   add_index :votes, [:voter_id, :voter_type, :vote_scope], name: 'index_votes_on_voter_and_scope'
  end
end
